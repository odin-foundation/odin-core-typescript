...
export const VERB_SIGNATURES: Record<string, VerbSignature> = {
  ...
  escapeHtml: { args: ['string'] },
  unescapeHtml: { args: ['string'] },
  escapeXml: { args: ['string'] },
  stripTags: { args: ['string'] },
  template: { args: ['string', 'object'] },
  ...
  gcd: { args: ['integer', 'integer'] },
  lcm: { args: ['integer', 'integer'] },
  factorial: { args: ['integer'] },
  ...
  countIf: { args: ['array', 'string', 'string', 'any'] },
  sumIf: { args: ['array', 'string', 'string', 'any', 'string'] },
  avgIf: { args: ['array', 'string', 'string', 'any', 'string'] },
  flatten: { args: ['array'] },
  ...
  intersection: { args: ['array', 'array'] },
  union: { args: ['array', 'array'] },
  difference: { args: ['array', 'array'] },
  symmetricDifference: { args: ['array', 'array'] },
  countBy: { args: ['array', 'string'] },
  keyBy: { args: ['array', 'string'] },
  explode: { args: ['array', 'string'] },
  window: { args: ['array', 'number'] },
  ...
  xnpv: { args: ['number', 'array', 'array'] },
  xirr: { args: ['array', 'array', 'number'] },
  ...
  sha256: { args: ['string'] },
  sha512: { args: ['string'] },
  base64urlEncode: { args: ['string'] },
  base64urlDecode: { args: ['string'] },
  hmac: { args: ['string', 'string', 'string'] },
  parseUrl: { args: ['string'] },
  buildUrl: { args: ['object'] },
  parseQuery: { args: ['string'] },
  buildQuery: { args: ['object'] },
  stableStringify: { args: ['any'] },
  canonicalHash: { args: ['any'] },
  sha1: { args: ['string'] },
  md5: { args: ['string'] },
  crc32: { args: ['string'] },
